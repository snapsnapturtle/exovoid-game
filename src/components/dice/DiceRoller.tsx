...
import { rollDice } from '~/lib/server/dice'
...
export function DiceRoller({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md rounded-xl border border-void-600 bg-void-800 p-6 shadow-xl"
      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center gap-3">
            <DieCounter type="standard" count={adjusted.standard} size="md" />
            {adjusted.aptitude > 0 && (
              <DieCounter type="aptitude" count={adjusted.aptitude} size="md" />
            )}
