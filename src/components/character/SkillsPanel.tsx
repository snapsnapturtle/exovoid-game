  ...
  return (
    <div className="rounded-xl border border-void-600 bg-void-800 p-6">
      ...
      <div className="space-y-1">
        <div className="grid grid-cols-[1fr_auto_auto_auto] gap-2 px-2 text-xs text-gray-500">
          <span>Skill</span>
        ...
        {filtered.map((skill) => {
          ...
          return (
            <div
              key={skill.id}
              className="grid grid-cols-[1fr_auto_auto_auto] items-center gap-2 rounded-lg px-2 py-1.5 hover:bg-void-700"
            >
              <div>
