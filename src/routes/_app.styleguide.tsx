    ...
    <div className="h-full overflow-auto">
      ...
      <header>
        ...
        <p className="mt-2 text-sm text-gray-900">
          ...
          . Use these when building new surfaces; match the conventions
      ...
      >
        ...
        >
          <p className="text-sm text-gray-1000">
            ...
            <code className="ml-1 text-gray-900">side=&quot;left&quot;</code>{' '}
      ...
      >
        <Row label="Recipe">
          ...
          <code className="text-xs text-gray-700">
            h-5 w-5 shrink-0 rounded bg-gray-400 not-disabled:hover:bg-gray-500
            disabled:cursor-not-allowed disabled:opacity-30 text-xs text-gray-1000
          </code>
        </Row>
      </Section>
      </div>
