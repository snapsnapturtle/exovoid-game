  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      ...
      <div className="flex gap-4">
        <a
          href="/login"
          className="rounded-lg bg-accent-500 px-6 py-3 font-medium text-white transition hover:bg-accent-400"
        >
          Log In
        </a>
        <a
          href="/signup"
          className="rounded-lg border border-gray-600 px-6 py-3 font-medium text-gray-300 transition hover:border-gray-400 hover:text-white"
        >
          Sign Up
        </a>
      </div>
